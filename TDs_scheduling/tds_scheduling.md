...
$$
\begin{align}
&i=1 \Rightarrow &W_1(0) = 3* 1 = 3 \\
                &&W_1(3) = 3* \left \lceil\frac{3}{5} \right \rceil = 3 &\text{ ok}\\
\\
&i=2 \Rightarrow &W_2(0) = 3* \left \lceil\frac{0}{5} \right \rceil + 3* 1 = 6 \\
...
\\
&i=3 \Rightarrow &W_3(0)  = 3* \left \lceil\frac{0}{5}  \right \rceil + 3* 1 + 2* 1 = 8 \\
